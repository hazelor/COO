...
def get_dev_conf():
    ...
    name_list = [TARGET_CONCENTRATION, MEASURED_CONCENTRATION, AIR_TEMPERATURE, AIR_HUMIDITY, SOIL_TEMPERATURE, SOIL_HUMIDITY]
    start_pos_list = [0, 4, 40, 60, 80, 88]
    ...
    name_list = [TARGET_CONCENTRATION, MEASURED_CONCENTRATION, AIR_TEMPERATURE, AIR_HUMIDITY]
    start_pos_list = [8, 12, 44, 64]
    for i in range(len(name_list)):
        para = copy.copy(para)
        para['name'] = name_list[i]
        para['start_pos'] = start_pos_list[i]
    ...
    name_list = [MEASURED_CONCENTRATION, AIR_TEMPERATURE, AIR_HUMIDITY,SOIL_TEMPERATURE, SOIL_HUMIDITY]
    start_pos_list = [96, 56, 76, 84, 92]
    for i in range(len(name_list)):
        para = copy.copy(para)
        para['name'] = name_list[i]
        para['start_pos'] = start_pos_list[i]
